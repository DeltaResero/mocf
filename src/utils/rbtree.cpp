...
int rb_is_null(const struct rb_node *n) { return n == &rb_null; }

const void *rb_get_data(const struct rb_node *n) { return n->data; }

void rb_set_data(struct rb_node *n, const void *data) { n->data = data; }
